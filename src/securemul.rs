...
//         ctx.helper_ring
//             .send(
//                 ctx.helper_ring.identity().peer(Direction::Right),
...
//             d: left_d,
//             index: left_index,
//         } = ctx.helper_ring.receive(ctx.helper_ring.identity().peer(Direction::Left), (self.index, self.step)).await?;
//
...
//
//                 let secure_mul =
//                     SecureMul::new(StreamingStep(stream_element_idx), index, a_share, b_share);
...
//             let f = async move {
//                 let h1_future =
//                     SecureMul::new(TestStep::Mul1(i), record_id, a[0], b[0]).execute(&ctx[0]);
//                 let h2_future =
//                     SecureMul::new(TestStep::Mul1(i), record_id, a[1], b[1]).execute(&ctx[1]);
//                 let h3_future =
//                     SecureMul::new(TestStep::Mul1(i), record_id, a[2], b[2]).execute(&ctx[2]);
//
...
//             SecureMul::new(TestStep::Mul2, index, a[0], b[0]).execute(&context[0]),
//             SecureMul::new(TestStep::Mul2, index, a[1], b[1]).execute(&context[1]),
//             SecureMul::new(TestStep::Mul2, index, a[2], b[2]).execute(&context[2]),
//         )?;
//
