...
use super::{
    boolean::{
        equality_test, multiply_all_shares, random_bits_generator::RandomBitsGenerator, RandomBits,
    },
            ...
            async move {
                let futures = row
                    ...
                    .map(|(j, (x, y))| {
                        ...
                        async move { equality_test(ctx_for_check, record_id, rbg_ref, x, &y).await }
                    });
