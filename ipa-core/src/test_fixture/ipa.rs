        ...
        .semi_honest(
            ...
            |ctx, input_rows: Vec<OPRFIPAInputRow<BA8, BA3, BA20>>| async move {
                ...
                match config.per_user_credit_cap {
                    8 => oprf_ipa::<BA8, BA3, BA20, BA3, F>(ctx, input_rows, aws)
                    .await
                    .unwrap(),
                    16 => oprf_ipa::<BA8, BA3, BA20, BA4, F>(ctx, input_rows, aws)
                    .await
                    .unwrap(),
                    32 => oprf_ipa::<BA8, BA3, BA20, BA5, F>(ctx, input_rows, aws)
                    .await
                    .unwrap(),
                    64 => oprf_ipa::<BA8, BA3, BA20, BA6, F>(ctx, input_rows, aws)
                    .await
                    .unwrap(),
                    128 => oprf_ipa::<BA8, BA3, BA20, BA7, F>(ctx, input_rows, aws)
                    .await
                    .unwrap(),
                    _ =>
                    panic!(
